...
- Rune drawing is constrained to the current three-card `runeHand`. Tapping the mobile arcane circle opens Arcane Focus; a second tap locks in immediately, or a completed stroke auto-locks after two seconds. Non-hand or unrecognised gestures leave the mode active; Escape cancels.
