...
- The hub Settings control toggles a compact alternate touch layout. Classic keeps its original fixed lower-left joystick and right action cluster; alternate uses a dynamic left-thumb joystick, fixed lower-left Draw, a central right Cast, Swap at 10 o'clock, Block at 7 o'clock, and a vertical right-side Jump control.
