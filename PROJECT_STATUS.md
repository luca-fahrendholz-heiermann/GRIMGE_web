...
- Rune cards are the primary Draw controls: tap a hand card to open Arcane Focus for that exact card, then tap any rune card again to lock/close. There is no standalone Draw button. Double-tapping a free left-side area opens Arcane Focus; double-tapping there again locks/closes it.
